...
def make_control_volume(unit,name,config):
    ...
    control_volume.properties_avg=config.property_package.build_state_block(defined_state=False,has_phase_equilibrium=config.has_phase_equilibrium)    
